...
export const TEST_SESSION_ID = 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee';
...
export const setupTestData = async (em: EntityManager) => {
  ...
  const { DiceRtrRecord } =
    await import('../persistence/entities/diceRtrRecord.entity');
...
export const mockDiceRtrData = { message: 'New test message' };
export const mockRollData = { dieType: 'd6', sessionId: TEST_SESSION_ID };
